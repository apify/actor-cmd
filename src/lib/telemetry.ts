...
const TELEMETRY_WARNING_TEXT =
	'Apify collects telemetry data about general usage of Actor CLI to help us improve the product. ' +
	'This feature is enabled by default, and you can disable it by setting the "ACTOR_CLI_DISABLE_TELEMETRY" environment variable to "1". ' +
...
export const isTelemetryEnabled =
	!process.env.ACTOR_CLI_DISABLE_TELEMETRY || ['false', '0'].includes(process.env.ACTOR_CLI_DISABLE_TELEMETRY);
